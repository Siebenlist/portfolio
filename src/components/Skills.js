   ...
   return (
      <div className="flex flex-col mx-auto w-full h-[700px] mt-24 bg-white justify-center align-center">
         <div className=" items-center h-[550px]">
            ...
            <div className="flex flex-col w-full h-full justify-center items-center md:flex-row lg:px-16 mx-auto gap-16">
               <div className="flex justify-center flex-wrap items-center w-[450px] md:w-full lg:h-[300px] lg:w-[550px] gap-10 ">
                  <img
                     src={cssLogo}
                     alt=""
               ...
               <div className="w-full lg:w-[700px] h-auto">
                  <p className="mb-5 text-base text-[#05083F] lg:text-lg px-12 md:px-16">
                     Through the course of 2021-2022 I started to learn a few
                     languages and use them in some small projects.
                  </p>

                  <p className="text-base text-[#05083F] lg:text-lg px-12 md:px-16">
